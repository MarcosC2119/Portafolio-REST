...
<body class="min-h-screen bg-black text-gray-100">
  ...
  <div class="max-w-xl mx-auto py-12 px-4">
    <div class="bg-gray-900 p-8 rounded-lg shadow-xl">
        <h2 class="text-3xl font-bold text-white mb-6 text-center">Agregar Proyecto</h2>
        <form method="post" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                <label for="descripcion" class="block text-gray-300 text-lg font-semibold mb-2">Descripción (máx. 200 caracteres)</label>
                <textarea name="descripcion" id="descripcion" maxlength="200" required
                          class="w-full px-4 py-2 rounded-md bg-gray-800 text-white border border-gray-700 focus:border-yellow-500 focus:ring focus:ring-yellow-500 focus:ring-opacity-50 h-32"></textarea>
            </div>
            <div>
            ...
            <div>
                <label for="imagen" class="block text-gray-300 text-lg font-semibold mb-2">Imagen</label>
